...
![Directed graph visualization showing ROS transform tree hierarchy with map and base_link coordinate frames and their parent-child relationships](frames.pdf)
...
![Gazebo simulation environment displaying a brick-textured world with a mobile robot positioned in the simulated space](brick_world.png)
